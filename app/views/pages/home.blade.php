					...
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img class="img-responsive" src="/assets/img/slider/s1.jpg" alt="" />
							</div>
							<div class="item">
								<img class="img-responsive" src="/assets/img/slider/s2.jpg" alt="" />
							</div>
							<div class="item">
								<img class="img-responsive" src="/assets/img/slider/s3.jpg" alt="" />
							</div>
						</div>
			...
			<div class="main-content">
				...
				<div class="pricing padd">
					<div class="default-heading">
						<!-- Crown image -->
						<img class="img-responsive" src="/assets/img/logo.png" alt="" width="100px" height="40px" />
						<!-- Heading -->
						<h3><b>ေအာ္ဒါမွာယူႏိုင္ေသာ စားေသာက္ဖြယ္ရာမ်ား</b></h3>
						<!-- Border -->
						...
						<div class="row">
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="/assets/img/dish/dish3.jpg" alt="" /></a>
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="/assets/img/dish/dish2.jpg" alt="" /></a>
									<!-- Pricing item details -->
									<div class="pricing-item-details">
										<!-- Heading -->
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="/assets/img/dish/dish4.jpg" alt="" /></a>
									<!-- Pricing item details -->
									<div class="pricing-item-details">
										<!-- Heading -->
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="/assets/img/dish/dish1.jpg" alt="" /></a>
									<!-- Pricing item details -->
									<div class="pricing-item-details">
										<!-- Heading -->
